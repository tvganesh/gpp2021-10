    ...
    if(type == "IPL"){
        ...
        if(input$T20BowlingPerfFunc == "IPL bowlers rank")
            a <-rankT20Bowlers("./ipl/iplPerformance",input$minMatches1, input$dateRange6,input$wicketsOverER,"IPL")
             ...
             a <- overallWicketsERPlotT20M("./ipl/IPLPerformance",input$minMatches1, input$dateRange6,"IPL",input$plotOrTable4)
        # else if(input$T20PerfFunc == "IPL Runs vs SR Powerplay plot")
        #     a <- overallRunsSRPPowerplayPlotT20M("./ipl/IPLPerformance",input$dateRange5,"IPL",input$plotOrTable4)
        # else if(input$T20PerfFunc == "IPL Runs vs SR Middle overs plot")
        #     a <- overallRunsSRMiddleOversPlotT20M("./ipl/IPLPerformance", input$dateRange5,"IPL",input$plotOrTable4)
        # else if(input$T20PerfFunc == "IPL Runs vs SR Death overs plot")
        #     a <- overallRunsSRDeathOversPlotT20M("./ipl/IPLPerformance", input$dateRange5,"IPL",input$plotOrTable4)
